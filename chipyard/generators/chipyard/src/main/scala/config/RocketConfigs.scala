...
//   // DOC include start(@zwk): LCMRocketConfig
// class LCMRocketConfig extends Config(
//   new chipyard.iobinders.WithUARTAdapter ++
//   new chipyard.iobinders.WithTieOffInterrupts ++
//   new chipyard.iobinders.WithBlackBoxSimMem ++
//   new chipyard.iobinders.WithTiedOffDebug ++
...
//   new chipyard.config.WithBootROM ++
//   new chipyard.config.WithL2TLBs(1024) ++
//   new rocclcm.WithLCMRoCCAccel ++          // Use LCM RoCC accelerator
//   new freechips.rocketchip.subsystem.WithNoMMIOPort ++
//   new freechips.rocketchip.subsystem.WithNoSlavePort ++
//   new freechips.rocketchip.subsystem.WithInclusiveCache ++
//   new freechips.rocketchip.subsystem.WithNExtTopInterrupts(0) ++
...
//   new freechips.rocketchip.subsystem.WithCoherentBusTopology ++
//   new freechips.rocketchip.system.BaseConfig)
// // DOC include end: LCMRocketConfig

//  // DOC include start(@zwk): L1CacheROCCRocketConfig
// class L1CacheRoCCRocketConfig extends Config(
//   new chipyard.iobinders.WithUARTAdapter ++
//   new chipyard.iobinders.WithTieOffInterrupts ++
//   new chipyard.iobinders.WithBlackBoxSimMem ++
//   new chipyard.iobinders.WithTiedOffDebug ++
...
//   new chipyard.config.WithBootROM ++
//   new chipyard.config.WithL2TLBs(1024) ++
//   new roccmem.WithL1CacheRoCC ++          // Use roccmem RoCC accelerator
//   new freechips.rocketchip.subsystem.WithNoMMIOPort ++
//   new freechips.rocketchip.subsystem.WithNoSlavePort ++
//   new freechips.rocketchip.subsystem.WithInclusiveCache ++
//   new freechips.rocketchip.subsystem.WithNExtTopInterrupts(0) ++
...
//   new freechips.rocketchip.subsystem.WithCoherentBusTopology ++
//   new freechips.rocketchip.system.BaseConfig)
// // DOC include end: L1CacheROCCRocketConfig

//  // DOC include start(@zwk): RoCCDMAStrideRocketConfig
// class RoCCDMAStrideRocketConfig extends Config(
//   new chipyard.iobinders.WithUARTAdapter ++
//   new chipyard.iobinders.WithTieOffInterrupts ++
//   new chipyard.iobinders.WithBlackBoxSimMem ++
//   new chipyard.iobinders.WithTiedOffDebug ++
...
//   new chipyard.config.WithBootROM ++
//   new chipyard.config.WithL2TLBs(1024) ++
//   new rocc_dma_stride.WithRoCCDMAStride ++          // Use RoCCDMAStrideRocketConfig
//   new freechips.rocketchip.subsystem.WithNoMMIOPort ++
//   new freechips.rocketchip.subsystem.WithNoSlavePort ++
//   //new freechips.rocketchip.subsystem.WithInclusiveCache ++
//   new freechips.rocketchip.subsystem.WithNExtTopInterrupts(0) ++
...
//   new freechips.rocketchip.subsystem.WithCoherentBusTopology ++
//   new freechips.rocketchip.system.BaseConfig)
// // DOC include end: RoCCDMAStrideRocketConfig


//@zwk memory access without buffer
// class MemaccerNoBufferRocketConfig extends Config(
//   new chipyard.iobinders.WithUARTAdapter ++
//   new chipyard.iobinders.WithTieOffInterrupts ++
//   new chipyard.iobinders.WithBlackBoxSimMem ++
//   new chipyard.iobinders.WithTiedOffDebug ++
...
//   new chipyard.config.WithBootROM ++
//   new chipyard.config.WithL2TLBs(1024) ++
//   new memaccer.WithMemaccerNoBuffer ++                        // Use RoCCMemaccerNoBuffer
//   new freechips.rocketchip.subsystem.WithNoMMIOPort ++
//   new freechips.rocketchip.subsystem.WithNoSlavePort ++
//   //new freechips.rocketchip.subsystem.WithInclusiveCache ++  // with L2$
//   new freechips.rocketchip.subsystem.WithNExtTopInterrupts(0) ++
//   new freechips.rocketchip.subsystem.WithNBigCores(1) ++
//   new freechips.rocketchip.subsystem.WithCoherentBusTopology ++
//   new freechips.rocketchip.system.BaseConfig)

//@zwk memory access with buffer
// class MemaccerHasBufferRocketConfig extends Config(
//   new chipyard.iobinders.WithUARTAdapter ++
//   new chipyard.iobinders.WithTieOffInterrupts ++
//   new chipyard.iobinders.WithBlackBoxSimMem ++
//   new chipyard.iobinders.WithTiedOffDebug ++
...
//   new chipyard.config.WithBootROM ++
//   new chipyard.config.WithL2TLBs(1024) ++
//   new memaccer.WithMemaccerHasBuffer ++                       // Use RoCCMemaccerHasBuffer
//   new freechips.rocketchip.subsystem.WithNoMMIOPort ++
//   new freechips.rocketchip.subsystem.WithNoSlavePort ++
//   //new freechips.rocketchip.subsystem.WithInclusiveCache ++  // with L2$
//   new freechips.rocketchip.subsystem.WithNExtTopInterrupts(0) ++
...
//   new freechips.rocketchip.system.BaseConfig)
  ...
  //@zwk memory access with buffer
class MemaccerAccel extends Config(
  new chipyard.iobinders.WithUARTAdapter ++
  new chipyard.iobinders.WithTieOffInterrupts ++
  new chipyard.iobinders.WithBlackBoxSimMem ++
  new chipyard.iobinders.WithTiedOffDebug ++
  ...
  new chipyard.config.WithBootROM ++
  new chipyard.config.WithL2TLBs(1024) ++
  new memaccer.WithMemaccerAccel ++                       // Use WithMemaccerAccel
  new freechips.rocketchip.subsystem.WithNoMMIOPort ++
  new freechips.rocketchip.subsystem.WithNoSlavePort ++
  //new freechips.rocketchip.subsystem.WithInclusiveCache ++  // with L2$
  new freechips.rocketchip.subsystem.WithNExtTopInterrupts(0) ++
